...
| CollectionType         | `@PropertyType(CharSequence.class)`<br>`List<? extends String> getSomething();`                                                                                                                         | Allows to select different serializer type for given property collection type                                                                                                                                                                                                                                                                                                                                             |
